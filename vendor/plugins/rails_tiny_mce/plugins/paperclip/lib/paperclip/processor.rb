module Paperclip
  ...
  # style hash, and the Paperclip::aAsset itself.
  #
  ...
  class Processor
    attr_accessor :file, :options, :asset

    def initialize file, options = {}, asset = nil
      @file = file
      @options = options
      @asset = asset
    end
    ...
    def self.make file, options = {}, asset = nil
      new(file, options, asset).make
    end
  end
