...
AppConfig.advanced_mce_options = {
    ...
    :theme_advanced_buttons1 => %w{fontselect formatselect fontsizeselect bold italic underline justifyleft justifycenter justifyright},
    :theme_advanced_buttons2 => %w{indent outdent bullist numlist link unlink image media undo redo help code pasteword},
