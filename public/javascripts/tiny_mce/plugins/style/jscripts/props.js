...
function init() {
	...
	fillSelect(0, 'background_asset', 'style_background_asset', defaultAsset, ';', true);
...
function setupFormData() {
	...
	selectByValue(f, 'background_asset', ce.style.backgroundAsset, true, true);
...
function generateCSS() {
	...
	ce.style.backgroundAsset = f.background_asset.value;
